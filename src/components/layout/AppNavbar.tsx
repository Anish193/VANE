        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-10 h-16 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2.5 group">
            ...
            <div className="flex flex-col leading-none">
              <span className="text-white font-bold text-base tracking-tight">VANE</span>
              <span className="text-blue-400 text-[10px] font-medium tracking-widest uppercase">AI Platform</span>
            </div>
          </Link>
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            <Link
              href="/auth/signup"
              className="px-4 py-2 text-sm bg-blue-500 hover:bg-blue-400 text-white rounded-xl font-medium transition-all duration-200 shadow-[0_0_20px_rgba(59,130,246,0.2)]"
            >
              Get Started
            </Link>
          </div>
          ...
          >
            <div className="px-6 py-4 flex flex-col gap-1">
              ...
              <div className="border-t border-white/5 mt-2 pt-3 flex flex-col gap-2">
                <Link href="/auth/login" className="px-4 py-2.5 text-sm text-white/70 hover:text-white rounded-xl hover:bg-white/5 transition-all">
                  Sign in
                </Link>
                <Link href="/auth/signup" className="px-4 py-2.5 text-sm bg-blue-500 text-white rounded-xl font-medium text-center">
                  Get Started
                </Link>
              </div>
            </div>
